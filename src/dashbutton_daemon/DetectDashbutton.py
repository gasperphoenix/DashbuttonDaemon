# -*- coding: utf-8 -*-
"""Support module to determine the dashbutton hardware MAC address

This module will determine the hardware MAC address of a dashbutton once it is pushed
"""
...
#===============================================================================
# Website to lookup vendor information for MAC addresses:
...
def arp_pkt(pkt):
        if ARP in pkt:
            if pkt[ARP].op == 1:
                    ...
                    if (mac.startswith('6C:56:97')):
                        logger.info("New MAC detected: %s (Amazon Technologies Inc.)" %(mac))
                    else:
                        logger.info("New MAC detected: %s" %(mac))
